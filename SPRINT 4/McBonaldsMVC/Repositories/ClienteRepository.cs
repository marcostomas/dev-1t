    ...
    public class ClienteRepository
    {
        ...
        public Cliente ObterPor(string email)
        {
            ...
            foreach(var linha in linhas)
            {
                ...
                c.DataNascimento = DateTime.Parse(ExtrairValorDoCampo("data_nascimneto", linha));
                
                // ↓ Aqui acaba o método
                return c;
                }
            }
            // ↓ Este return não será executado, já que, há o {return c} acima
            return null;
        }
